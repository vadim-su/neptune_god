...
const DEFAULT_ENTRIES := [
	{"id": "basic_miner", "label": "Basic miner", "glyph": "M"},
	{"id": "wooden_chest", "label": "Wooden chest", "glyph": "C"},
	{"id": "basic_belt", "label": "Basic belt", "glyph": "B"},
	{"id": "stone_furnace", "label": "Stone furnace", "glyph": "F"},
	{"id": "basic_inserter", "label": "Basic inserter", "glyph": "I"},
	{"id": "basic_assembler", "label": "Basic assembler", "glyph": "A"},
	{"id": "accelerated_belt", "label": "Accelerated belt", "glyph": "B+"},
	{"id": "fast_belt", "label": "Fast belt", "glyph": "B++"},
	{"id": "basic_splitter", "label": "Basic splitter", "glyph": "S"},
	{"id": "basic_underground_belt", "label": "Underground belt", "glyph": "U"},
]
...
func _add_slot(parent: Control, index: int) -> void:
	...
	icon.text = slots[index].get("glyph", "")
	icon.add_theme_font_size_override("font_size", 20)
	icon.add_theme_color_override("font_color", Color(0.88, 0.92, 0.84, 1.0))
...
func _refresh_visuals() -> void:
	for index in _slot_buttons.size():
		...
		_icon_labels[index].modulate = Color(1.0, 1.0, 1.0, 0.42) if assigning else Color.WHITE
